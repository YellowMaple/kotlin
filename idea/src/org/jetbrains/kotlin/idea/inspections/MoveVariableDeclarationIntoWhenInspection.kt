...
private enum class Action {
    ...
    val description: String
        get() = when (this) {
            MOVE -> "Variable declaration could be moved inside `when`"
            INLINE -> "Variable declaration could be inline inside `when`"
...
private class VariableDeclarationIntoWhenFix(
    ...
    override fun getName() = "$actionName the variable into `when`"

...
open class FatFrameworkTask: DefaultTask() {
     ...
     */
    @Internal  // Take it into account in the frameworkDir property.
    var destinationDir: File = project.buildDir.resolve("fat-frameworks")
    // endregion.
    ...
    @get:OutputDirectory
    protected val fatFrameworkDir: File
        get() = fatFramework.rootDir

    @get:OutputDirectory
    protected val fatDsymDir: File
        get() = fatDsym.rootDir
